...
class RewritingService
{
    ...
    private array $synonyms = [
        ...
        'home' => ['residence', 'living space', 'dwelling', 'abode', 'house'],
        'room' => ['space', 'area', 'chamber', 'interior'],
        'decor' => ['decoration', 'furnishing', 'styling', 'adornment', 'embellishment'],
        'design' => ['style', 'aesthetic', 'layout', 'arrangement', 'concept'],
        'furniture' => ['furnishings', 'pieces', 'items', 'fixtures'],
        'color' => ['hue', 'shade', 'tone', 'tint', 'palette'],
        'space' => ['area', 'room', 'environment', 'setting'],
        'style' => ['aesthetic', 'look', 'design', 'theme', 'approach'],
        'cozy' => ['warm', 'inviting', 'comfortable', 'snug', 'welcoming', 'homey'],
        'elegant' => ['sophisticated', 'refined', 'stylish', 'graceful', 'chic'],
        'minimalist' => ['simple', 'clean', 'streamlined', 'uncluttered', 'understated'],
        'comfortable' => ['cozy', 'relaxing', 'plush', 'inviting', 'snug'],
        'vibrant' => ['lively', 'bold', 'vivid', 'energetic', 'dynamic'],
        'transform' => ['revamp', 'renovate', 'upgrade', 'refresh', 'reimagine', 'reinvent'],
        'atmosphere' => ['ambiance', 'mood', 'feel', 'vibe', 'environment'],
        'accent' => ['highlight', 'feature', 'focal point', 'touch', 'detail'],
        'lighting' => ['illumination', 'light fixtures', 'lamps', 'light sources'],
        'texture' => ['feel', 'surface', 'fabric', 'material', 'finish'],
        'layout' => ['arrangement', 'configuration', 'setup', 'organization'],
        'aesthetic' => ['visual appeal', 'look', 'style', 'appearance'],
        'inviting' => ['welcoming', 'warm', 'appealing', 'attractive', 'hospitable'],
        'spacious' => ['roomy', 'open', 'airy', 'expansive', 'generous'],
        'natural' => ['organic', 'earthy', 'nature-inspired', 'botanical'],
        'incorporate' => ['integrate', 'include', 'add', 'introduce', 'blend'],
        'enhance' => ['improve', 'elevate', 'boost', 'amplify', 'enrich'],
        'create' => ['craft', 'design', 'establish', 'build', 'develop'],
        'element' => ['feature', 'component', 'aspect', 'detail', 'piece'],
        'look' => ['appearance', 'style', 'aesthetic', 'visual', 'feel'],
        'warmth' => ['coziness', 'comfort', 'inviting feel', 'welcoming atmosphere'],
