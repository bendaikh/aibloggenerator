                ...
                <div class="space-y-6">
                    <div class="bg-[#1a1a1a] rounded-2xl border border-[#2a2a2a] p-6">
                        ...
                        <div class="rounded-xl overflow-y-auto overflow-x-hidden mx-auto relative max-h-[800px] scrollbar-thin scrollbar-thumb-pink-500 scrollbar-track-[#2a2a2a]" style="max-width: 512px;">
                            <!-- Loading overlay -->
                            <div v-if="isGeneratingPreview && previewImage" class="absolute inset-0 bg-black/40 flex items-center justify-center z-10 rounded-xl">
                                <div class="flex items-center gap-2 bg-black/70 px-4 py-2 rounded-lg">
                                    <svg class="animate-spin h-5 w-5 text-pink-400" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                    </svg>
