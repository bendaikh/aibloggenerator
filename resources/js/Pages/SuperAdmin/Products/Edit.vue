...
const form = useForm({
    ...
    gallery_images: props.product.gallery_images || [],
    sku: props.product.sku || '',
    stock_quantity: props.product.stock_quantity || 0,
    track_stock: props.product.track_stock || false,
    is_digital: props.product.is_digital || false,
    digital_file_url: props.product.digital_file_url || '',
    external_url: props.product.external_url || '',
...
const submit = () => {
    form.put(route('superadmin.products.update', { 
    ...
    <SuperAdminLayout :currentWebsite="currentWebsite">
        <div class="p-4 lg:p-8 max-w-4xl">
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 class="text-2xl lg:text-3xl font-bold text-white">Edit Product</h1>
