        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-[#1a1a1a] rounded-2xl border border-[#2a2a2a] p-6">
                    ...
                    <button class="w-full bg-[#1DA1F2] hover:bg-[#1a8cd8] text-white py-2 rounded-lg font-medium transition-colors">
                        Connect
                    </button>
                </div>
                ...
                <div class="bg-[#1a1a1a] rounded-2xl border border-[#2a2a2a] p-6">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="w-12 h-12 bg-[#1877F2]/20 rounded-xl flex items-center justify-center">
                    ...
                    <button class="w-full bg-[#1877F2] hover:bg-[#166fe5] text-white py-2 rounded-lg font-medium transition-colors">
                        Connect
                    </button>
                </div>
                ...
                <div class="bg-[#1a1a1a] rounded-2xl border border-[#2a2a2a] p-6">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="w-12 h-12 bg-[#0A66C2]/20 rounded-xl flex items-center justify-center">
                    ...
                    <button class="w-full bg-[#0A66C2] hover:bg-[#095196] text-white py-2 rounded-lg font-medium transition-colors">
                        Connect
                    </button>
                </div>
                ...
                <div class="bg-[#1a1a1a] rounded-2xl border border-[#2a2a2a] p-6">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="w-12 h-12 bg-[#E60023]/20 rounded-xl flex items-center justify-center">
                        ...
                        <div>
                            <h3 class="text-white font-semibold">Pinterest</h3>
                            <p class="text-gray-500 text-sm">Not connected</p>
                        </div>
                    </div>
                    <button class="w-full bg-[#E60023] hover:bg-[#c5001e] text-white py-2 rounded-lg font-medium transition-colors">
                        Connect
                    </button>
                </div>
            </div>
