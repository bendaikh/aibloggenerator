        ...
        <div class="py-12 md:py-20 bg-[#F0F4EF]">
            <div class="container mx-auto px-4">
                ...
                <header class="text-center mb-16">
                    ...
                    <h1 class="text-5xl md:text-7xl font-black text-[#3A5A40] mb-6 leading-tight">{{ category.name }}</h1>
                    <p v-if="category.description" class="text-lg md:text-xl text-[#344E41] max-w-2xl mx-auto font-medium">
                ...
                <div v-else class="text-center py-20 bg-white rounded-[3rem] shadow-xl max-w-4xl mx-auto border-4 border-dashed border-[#D8E2DC]">
                    ...
                    <h3 class="text-3xl font-black text-[#3A5A40] mb-4 uppercase tracking-widest">No patterns yet</h3>
                    <p class="text-[#588157] font-medium">Our artisans are hard at work. Check back soon for new creations!</p>
                </div>
