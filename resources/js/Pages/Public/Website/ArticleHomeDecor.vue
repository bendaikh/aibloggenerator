<template>
    <HomeDecorLayout :website="website">
        ...
        <article class="bg-white">
            ...
            <div v-if="article.processed_featured_image || article.featured_image" class="relative">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        <main class="lg:col-span-9 order-1 lg:order-2">
                            ...
                            <div v-if="galleryImages.length > 0" class="mt-12 space-y-8">
                                <h3 class="text-xl font-serif font-bold text-[#2D2D2D] text-center">More Images</h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    >
                                        ...
                                        <!-- Caption -->
                                        <p v-if="image.title" class="text-center text-sm text-[#8B8B8B] italic">
                                            {{ image.title }}
                                        </p>
                                    </div>
                                </div>
    ...
    content = content.replace(/<h([23])([^>]*)>([^<]+)<\/h\1>/gi, (match, level, attrs, text) => {
        ...
        if (level === '2') {
            ...
            if (matchedImage && !usedIds.has(matchedImage.id)) {
                ...
                // Create image HTML to inject after the header
                const imageHtml = `
