        ...
        <aside :class="[
            ...
            <div class="flex-1 overflow-y-auto p-4">
                ...
                <nav class="mt-3 space-y-1">
                    ...
                    <Link 
                        :href="currentWebsite ? route('superadmin.geo', { website: currentWebsite.id }) : '#'" 
                        @click="handleNavClick"
                        :class="[
                            'flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors',
                            isActive('superadmin.geo') 
                                ? 'bg-[#1f1f1f] text-white' 
                                : 'text-gray-400 hover:bg-[#1a1a1a] hover:text-white'
                        ]"
                    >
                    ...
                    <!-- Shop Products -->
                    <Link 
                        :href="currentWebsite ? route('superadmin.products.index', { website: currentWebsite.id }) : '#'" 
                        @click="handleNavClick"
                        :class="[
                            'flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors',
                            isActivePrefix('superadmin.products') 
                                ? 'bg-[#1f1f1f] text-white' 
                                : 'text-gray-400 hover:bg-[#1a1a1a] hover:text-white'
                        ]"
                    >
