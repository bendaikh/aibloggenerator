...
Route::middleware(['auth', 'verified'])->prefix('superadmin')->group(function () {
    ...
    // Content Management (keeping legacy routes for now)
...
// Public Website Routes - Subdomain and Custom Domain based
Route::domain('{domain}')->middleware('identify.website')->group(function () {
